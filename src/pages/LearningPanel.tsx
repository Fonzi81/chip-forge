          ...
          <TabsContent value="resources" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-slate-900/50 border-slate-700">
                ...
                <CardContent>
                  <div className="space-y-2 text-sm">
                    <div className="text-slate-400">• Counter design</div>
                    <div className="text-slate-400">• State machine template</div>
                    <div className="text-slate-400">• FIFO implementation</div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <h4 className="font-medium text-slate-300">Documentation</h4>
                    <div className="space-y-2 text-sm">
                      <a href="#" className="block text-blue-400 hover:text-blue-300">SystemVerilog LRM</a>
                      <a href="#" className="block text-blue-400 hover:text-blue-300">FPGA Vendor Guides</a>
                      <a href="#" className="block text-blue-400 hover:text-blue-300">Synthesis Guidelines</a>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <h4 className="font-medium text-slate-300">Tools & Utilities</h4>
                    <div className="space-y-2 text-sm">
                      ...
                      <a href="#" className="block text-blue-400 hover:text-blue-300">State Machine Generator</a>
                    </div>
                  </div>
                </div>
              </CardContent>
